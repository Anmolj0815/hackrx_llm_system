...
Original file is located at
    https://colab.research.google.com/drive/19oZnnTFTalOHoUtiiB-Z9bqM-nt-ldv2
"""
...
PINECONE_ENVIRONMENT = os.getenv("PINECONE_ENVIRONMENT") # e.g., "us-west-2" or "gcp-starter"
...
if not PINECONE_ENVIRONMENT:
    raise ValueError("PINECONE_ENVIRONMENT not set in .env")
...
def get_pinecone_index() -> Index:
    ...
    try:
        if PINECONE_INDEX_NAME not in pinecone.list_indexes():
            ...
            # Use PodSpec for serverless if available, or specify pod type for paid tiers
            # For starter environment, metric='cosine' and dimension=1536 (for text-embedding-ada-002) are standard.
            pinecone.create_index(
                name=PINECONE_INDEX_NAME,
                dimension=1536, # Dimension for text-embedding-ada-002
                metric='cosine',
                # spec=PodSpec(environment=PINECONE_ENVIRONMENT) # Use this for pod-based deployments
                # spec=ServerlessSpec(cloud='aws', region='us-west-2') # Use this for serverless if available in your tier
            )
